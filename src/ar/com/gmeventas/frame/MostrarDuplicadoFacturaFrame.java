 ...
 * @author Mario
 */
public class MostrarDuplicadoFacturaFrame extends javax.swing.JFrame {
     ...
     */
    public MostrarDuplicadoFacturaFrame(IvaVentas iv) {
    ...
    private void initComponents() {
        ...
        setTitle("Golosol Duplicado Factura");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MostrarDuplicadoFacturaFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MostrarDuplicadoFacturaFrame(null).setVisible(true);
            }
        });
    }
