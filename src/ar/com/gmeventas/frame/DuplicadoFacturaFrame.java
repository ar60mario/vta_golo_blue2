...
public class DuplicadoFacturaFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        notaCreditoMnu = new javax.swing.JButton();
    ...
    private javax.swing.JButton notaCreditoMnu;
    ...
    private void imprimirFacturaSeleccionada() {
        ...
        if (row > -1) {
            if (fac.getTotal() < 0.00) {
                MostrarDuplicadoNotaCreditoFrame mdff = new MostrarDuplicadoNotaCreditoFrame(fac);
                mdff.setVisible(true);
                this.dispose();
            } else {
                MostrarDuplicadoFacturaFrame mdff = new MostrarDuplicadoFacturaFrame(fac);
                mdff.setVisible(true);
                this.dispose();
            }
        }
    ...
    private void BuscarFacturasEntreFechas() {
        try {
        ...
        try {
            facturas = new IvaVentasService().getFacturasEntreFechas(dfe, hfe);
        } catch (Exception ex) {
            Logger.getLogger(DuplicadoFacturaFrame.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void ndc() {
        ...
        if (row > -1) {
            if (fac.getTotal() < 0.00) {
                JOptionPane.showMessageDialog(this, "NO DEBE GENERAR NC DE NC");
                return;
            } else {
                MostrarDuplicadoFacturaFrame mdff = new MostrarDuplicadoFacturaFrame(fac);
                mdff.setVisible(true);
