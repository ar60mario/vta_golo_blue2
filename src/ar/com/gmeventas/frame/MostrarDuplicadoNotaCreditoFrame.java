 ...
 * @author Mario
 */
public class MostrarDuplicadoNotaCreditoFrame extends javax.swing.JFrame {
    ...
    public MostrarDuplicadoNotaCreditoFrame(IvaVentas iv) {
        ...
        try {
            ...
            Logger.getLogger(MostrarDuplicadoNotaCreditoFrame.class.getName()).log(Level.SEVERE, null, ex);
        }
        cargarFrame();
    }
    ...
    private void initComponents() {
        ...
        setTitle("Golosol - Duplicado Nota Crédito");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MostrarDuplicadoNotaCreditoFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MostrarDuplicadoNotaCreditoFrame(null).setVisible(true);
            }
        });
    }
...
//        }
    ...
    private void cargarFrame() {
        ...
        if (renglonFactura != null && !renglonFactura.isEmpty()) {
            for (RenglonNotaCredito rf : renglonFactura) {
        ...
        try {
            ...
            Logger.getLogger(MostrarDuplicadoFacturaFrame.class.getName()).log(Level.SEVERE, null, ex);
        }
