...
public class NotaCreditoWebFrame extends javax.swing.JFrame {
    ...
    private Integer tst = 0; // en 1 es prueba test

    /**
     * Creates new form FacturaFrame
     */
    public NotaCreditoWebFrame() {
    ...
    private void initComponents() {
        ...
        setTitle("Golosol - Nota de Crédito Web");
        ...
        incorporarAFacturaBtn.setText("Incorporar a NC");
    ...
    private void leerCantidadBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_leerCantidadBtnActionPerformed
        ...
        if (lin > -1) {
            RenglonNotaCredito rf = renglonFactura.get(lin);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new NotaCreditoWebFrame().setVisible(true);
            }
        });
    }
...
// Sugerido
                    ...
                    // aqui detalle importes inscriptos en IVA
// Precio Unitario
                    str0 = tablaFactura.getValueAt(r, 3).toString();
                    str0 = str0.replace(",", ".");
                    Double doble = Double.valueOf(str0);
            ...
            if (pro.getInactivo() != null) {
                if (!pro.getInactivo()) {
                    if (!(pro.getSubRubro().getCodigo().equals(5099))) {
                        ...
                        Float impu = 0.00F;
                        if (pro.getImpuesto() != 0.00) {
                            impu = -1 * pro.getImpuesto();
                        }
