...
public class RenglonNotaCredito {
    ...
    public RenglonNotaCredito(Long id, Integer itemNro, Producto producto, String descripcion, Double gravado, Float cantidad, Double exento, Double noGravado, Double impuesto, Double descuento, Double iva, Double total, IvaVentas ivaVentas, Double sugerido, Double costoG, Double costoI) {
        this.id = id;
